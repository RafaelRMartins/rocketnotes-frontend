...
export function New() {
  ...
  const navigate = useNavigate();
    ...
    async function handleNewNote(){
      ...
      if(newLink){
        return alert("Você deixou um link no campo, e não adicionou")
      }
        ...
        <Form>
          ...
          <Section title="Marcadores">
            <div className='tags'>
              ...
              <NoteItem isNew placeholder="Novo tag" onChange={e => setNewTag(e.target.value)} value={newTag} onClick={handleAddTag} />
            </div>
          </Section>
